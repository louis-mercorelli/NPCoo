        ...
        try {
            event.getDispatcher().register(
                Commands.literal("testmod")
                    ...
                    .then(Commands.literal("lookSee").executes(CommandHandler::handleLookSee))
                    .then(Commands.literal("explore")
                        .then(Commands.argument("poi", StringArgumentType.word()).executes(CommandHandler::handleExplorePoi)))
                    .then(Commands.literal("exploreStop").executes(CommandHandler::handleExploreStop))
                    .then(Commands.literal("exploreStatus").executes(CommandHandler::handleExploreStatus))
                    .then(Commands.literal("debugON").executes(ctx -> CommandHandler.handleDebugScreenToggle(ctx, true)))
                    .then(Commands.literal("debugOFF").executes(ctx -> CommandHandler.handleDebugScreenToggle(ctx, false)))
                    .then(Commands.literal("scanSAI")
                        .executes(ctx -> CommandHandler.handleScanSai(ctx, "all", 2, false))
                        .then(Commands.literal("detail")
                            .then(Commands.argument("x", IntegerArgumentType.integer())
                                .then(Commands.argument("y", IntegerArgumentType.integer())
                                    .then(Commands.argument("z", IntegerArgumentType.integer())
                                        .then(Commands.argument("radius", IntegerArgumentType.integer(1))
                                            .executes(ctx -> CommandHandler.handleDetailSaiAtPos(ctx,
                        ...
                        .then(Commands.literal("detailSAI")
                            .executes(ctx -> CommandHandler.handleDetailSaiAtSteve(ctx, 1))
                            .then(Commands.argument("radius", IntegerArgumentType.integer(1))
                                .executes(ctx -> CommandHandler.handleDetailSaiAtSteve(ctx, IntegerArgumentType.getInteger(ctx, "radius")))))
                        .then(Commands.argument("scanArgs", StringArgumentType.greedyString()).executes(CommandHandler::handleScanSaiArgs)))
                    .then(Commands.literal("scanB")
                        .then(Commands.argument("x", IntegerArgumentType.integer())
                            .then(Commands.argument("y", IntegerArgumentType.integer())
                                .then(Commands.argument("z", IntegerArgumentType.integer())
                                    .then(Commands.argument("chunkRadius", IntegerArgumentType.integer(1))
                                        .executes(ctx -> CommandHandler.handleDirectCenteredScan(ctx, "scanB",
                                            new BlockPos(IntegerArgumentType.getInteger(ctx, "x"), IntegerArgumentType.getInteger(ctx, "y"), IntegerArgumentType.getInteger(ctx, "z")),
                    ...
                    .then(Commands.literal("scanE")
                        .then(Commands.argument("x", IntegerArgumentType.integer())
                            .then(Commands.argument("y", IntegerArgumentType.integer())
                                .then(Commands.argument("z", IntegerArgumentType.integer())
                                    .then(Commands.argument("chunkRadius", IntegerArgumentType.integer(1))
                                        .executes(ctx -> CommandHandler.handleDirectCenteredScan(ctx, "scanE",
                                            new BlockPos(IntegerArgumentType.getInteger(ctx, "x"), IntegerArgumentType.getInteger(ctx, "y"), IntegerArgumentType.getInteger(ctx, "z")),
                                            IntegerArgumentType.getInteger(ctx, "chunkRadius"), false))
                                        .then(Commands.literal("ForceLoad")
                                            .executes(ctx -> CommandHandler.handleDirectCenteredScan(ctx, "scanE",
                    ...
                    .then(Commands.literal("scanBE")
                        .then(Commands.argument("x", IntegerArgumentType.integer())
                            .then(Commands.argument("y", IntegerArgumentType.integer())
                                .then(Commands.argument("z", IntegerArgumentType.integer())
                                    .then(Commands.argument("chunkRadius", IntegerArgumentType.integer(1))
                                        .executes(ctx -> CommandHandler.handleDirectCenteredScan(ctx, "scanBE",
                                            new BlockPos(IntegerArgumentType.getInteger(ctx, "x"), IntegerArgumentType.getInteger(ctx, "y"), IntegerArgumentType.getInteger(ctx, "z")),
                                            IntegerArgumentType.getInteger(ctx, "chunkRadius"), false))
                                        .then(Commands.literal("ForceLoad")
                                            .executes(ctx -> CommandHandler.handleDirectCenteredScan(ctx, "scanBE",
                                                new BlockPos(IntegerArgumentType.getInteger(ctx, "x"), IntegerArgumentType.getInteger(ctx, "y"), IntegerArgumentType.getInteger(ctx, "z")),
                                                IntegerArgumentType.getInteger(ctx, "chunkRadius"), true))))))))
                    .then(Commands.literal("scanStatus").executes(CommandHandler::handleScanStatus))
                    .then(Commands.literal("serverLoad")
                        .executes(CommandHandler::handleServerLoadStatus)
                        .then(Commands.literal("stream")
                            .executes(CommandHandler::handleServerLoadStreamStatus)
                            .then(Commands.literal("on").executes(ctx -> CommandHandler.handleServerLoadStreamToggle(ctx, true)))
                            .then(Commands.literal("off").executes(ctx -> CommandHandler.handleServerLoadStreamToggle(ctx, false))))
                            ...
                            .then(Commands.argument("idleMspt", DoubleArgumentType.doubleArg(0.1, ServerLoad.SERVER_TICK_BUDGET_MS))
                                .then(Commands.argument("busyMspt", DoubleArgumentType.doubleArg(0.1, ServerLoad.SERVER_TICK_BUDGET_MS))
                                    .then(Commands.argument("behindDebtMs", DoubleArgumentType.doubleArg(1.0, 5000.0))
                                        .executes(CommandHandler::handleServerLoadTune)
                                        .then(Commands.argument("emaAlpha", DoubleArgumentType.doubleArg(0.01, 1.0))
                                            .executes(CommandHandler::handleServerLoadTune))))))
                        .then(Commands.literal("reset").executes(CommandHandler::handleServerLoadReset)))
                    .then(Commands.literal("poiStage1").executes(CommandHandler::handlePoiUpdate))
                    .then(Commands.literal("poiUpdate").executes(CommandHandler::handlePoiUpdate))
                    .then(Commands.literal("poiStage2")
                        .executes(ctx -> CommandHandler.handlePoiConfirmCandidates(ctx, 10))
                        .then(Commands.argument("limit", IntegerArgumentType.integer(1))
                            .executes(ctx -> CommandHandler.handlePoiConfirmCandidates(ctx, IntegerArgumentType.getInteger(ctx, "limit")))))
                    .then(Commands.literal("poiConfirmCandidates")
                        .executes(ctx -> CommandHandler.handlePoiConfirmCandidates(ctx, 10))
                        .then(Commands.argument("limit", IntegerArgumentType.integer(1))
                            .executes(ctx -> CommandHandler.handlePoiConfirmCandidates(ctx, IntegerArgumentType.getInteger(ctx, "limit")))))
                    .then(Commands.literal("poiReset").executes(CommandHandler::handlePoiReset))
                    .then(Commands.literal("writeT")
                        .executes(CommandHandler::handleWriteT)
                        .then(Commands.argument("suffix", StringArgumentType.greedyString()).executes(CommandHandler::handleWriteT)))
                    .then(Commands.literal("writeTD")
                        .executes(CommandHandler::handleWriteTD)
                        .then(Commands.argument("suffix", StringArgumentType.greedyString()).executes(CommandHandler::handleWriteTD)))
                    .then(Commands.literal("forceChunkOn").executes(CommandHandler::handleForceChunkOn))
                    .then(Commands.literal("forceChunkOff").executes(CommandHandler::handleForceChunkOff))
                    .then(Commands.literal("whereRu").executes(CommandHandler::handleWhereRu))
                    .then(Commands.literal("tele").executes(CommandHandler::handleTele))
                    .then(Commands.literal("followMe").executes(CommandHandler::handleFollowMe))
                    .then(Commands.literal("findMe").executes(CommandHandler::handleFindMe))
                    .then(Commands.literal("stopFollow").executes(CommandHandler::handleStopFollow))
                    .then(Commands.literal("opengui").executes(CommandHandler::handleOpenGui))
                    .then(Commands.literal("inv").executes(CommandHandler::handleInv))
                    ...
                    .then(Commands.literal("writeNow").executes(CommandHandler::handleWriteNow))
                    .then(Commands.argument("message", StringArgumentType.greedyString()).executes(CommandHandler::handleSteveAiChat))
            );
        } finally {
