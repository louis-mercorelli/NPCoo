...
public class SteveAiMenu extends MerchantMenu {
    ...
    public SteveAiMenu(int containerId, Inventory playerInventory) {
        ...
        LOGGER.info(com.sai.NpcooLog.tag("SteveAiMenu setting up first trade"));
    ...
    private static ClientSideMerchant createMerchant(Inventory playerInventory) {
        ...
        LOGGER.info(com.sai.NpcooLog.tag("SteveAiMenu clientSideMerchant called"));
        ...
        LOGGER.info(com.sai.NpcooLog.tag("SteveAiMenu offers count = " + merchant.getOffers().size()));
        return merchant;
    }
}
